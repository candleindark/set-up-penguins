...
echo "  Read curated (read curated area): $READ_CURATED_TOKEN"
echo "  Read collection (read incoming and curated areas): $READ_COLLECTION_TOKEN"
echo "  Write collection (read incoming and curated areas, write incoming area): $WRITE_COLLECTION_TOKEN"
